    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(default='resource/user_image/default.png', help_text='用户显示的头像！', upload_to='image/%Y/%m', verbose_name='头像')),
                ('sex', models.CharField(blank=True, choices=[('1', '男'), ('0', '女'), ('-1', '中')], default='-1', help_text='可不填 默认为中性！', max_length=3, null=True, verbose_name='性别')),
